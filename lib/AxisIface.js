...
export const axisIface = {
  ...
  // since: 2018-6-1, timeUnit: DAYS, x:9, valueFormatterPattern: YYYY-MM-dd
  // will display 2018-6-10
  valueFormatterPattern: PropTypes.string,
  since: PropTypes.number, // milliseconds of when x=0
...
export const yAxisIface = {
  ...
  extendGridlines: PropTypes.bool,
